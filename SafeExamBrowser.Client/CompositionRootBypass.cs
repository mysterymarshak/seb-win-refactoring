...
namespace SafeExamBrowser.Client
{
	internal class CompositionRootBypass
	{
			...
			Action shutdown)
		{
			...
			responsibilities.Enqueue(new IntegrityResponsibilityBypass(context, ModuleLogger(nameof(IntegrityResponsibility)), text));
		...
		private IOperation BuildBrowserOperation()
		{
			...
			var browser = new BrowserApplicationBypass(
				context.AppConfig,
