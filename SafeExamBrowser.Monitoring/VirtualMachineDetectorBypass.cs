...
{
	public class VirtualMachineDetectorBypass : IVirtualMachineDetector
	{
		...
		public VirtualMachineDetectorBypass(ILogger logger, IRegistry registry, ISystemInfo systemInfo)
		{
			this.logger = logger;
