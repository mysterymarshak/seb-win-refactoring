...
{
	public class ApplicationMonitorBypass : IApplicationMonitor
	{
		...
		public ApplicationMonitorBypass(int interval_ms, ILogger logger, INativeMethods nativeMethods, IProcessFactory processFactory)
		{
